...
class ContactsRepository implements BaseRepository {
  ...
  Future<DomesticResponseWrapper<GetContactsResponse>> getContacts() async {
    try {
      ...
      return DomesticResponseWrapper.builder(
          true, null, GetContactsResponse.fromJson(jsonDecode(stringResponse)));
